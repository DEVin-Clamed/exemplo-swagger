...
public class LivroController {
    ...
    @Operation ( summary = "Cadastrar novo livro", description = "Cadastr novo livro",
            responses = {
    ...
    @Operation( summary = "Alterar dados de Livro", description = "Altera dados de um livro cadastrado",
            responses = {
    ...
    @PutMapping("{id}")
    public ResponseEntity<Livro> alterar(@PathVariable("id")
                                         Integer id, @RequestBody Livro livro) {
        livro.setId(id);
    ...
    @Operation( summary = "Excluir Livro", description = "Exclui um livro existente",
            responses = {
                    @ApiResponse(responseCode = "204", description = "Excluisão realizada"),
                    @ApiResponse(responseCode = "404", description = "Registro não encontrado")
            })
    @DeleteMapping("{id}")
